              ...
              <div className="hidden md:flex space-x-4">
                {navItems.map((item) => (
                  <Link
                    ...
                    href={item.href}
                    className={cn(
                      "px-3 py-2 text-sm font-medium rounded-md transition-colors navbar-link-hover",
                      pathname === item.href
                        ? "bg-gradient-to-r from-emerald-900/50 to-purple-900/50 text-emerald-400 navbar-link-active"
              ...
              <nav className="flex flex-col space-y-4 mt-4 relative z-10">
                {navItems.map((item) => (
                  <Link
                    ...
                    href={item.href}
                    className={cn(
                      "text-lg font-medium text-gray-300 hover:text-emerald-400 transition-colors py-3 border-b border-gray-800/50 navbar-link-hover",
                      pathname === item.href ? "text-emerald-400 navbar-link-active" : "",
                    )}
                    onClick={() => setIsMenuOpen(false)}
                  >
                    {item.name}
